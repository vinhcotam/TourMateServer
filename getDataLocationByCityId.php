<?php
    ...
    $city_id = $_GET['city_id']; // Lấy city_id từ URL

    $query = "SELECT * FROM data_location WHERE city_id = $city_id";
    ...
    $locationByCityIDArray = array();
    while($row = mysqli_fetch_assoc($data)){
        array_push($locationByCityIDArray, new Data_Location($row['id'],$row['name'],$row['location'], $row['latitude'],
    ...
    echo json_encode($locationByCityIDArray);
?>
